...
const ForgotPassword = () => {
  ...
  return (
    <>
      <div className="bg-slate-800" style={{paddingTop:"10vh"}}>
        <div className="py-10 md:px-10 px-4 container mx-auto">
          <div className="verify-otp text-center">
            <div className="icon-bg">
              {/* <img src={icon} alt="iconimg" /> */}
              <LiaUserLockSolid className="text-7xl"/>
            </div>
            <h2 className="font-bold md:text-4xl text-2xl text-gray-200 gradient-text">
              Reset your password
            </h2>
            <p className="text-gray-200">
              Forgot you password? Please enter your emai and we'll set you a
              4-digit code.
            </p>
          </div>
            ...
            <div className="registration-form py-8 px-8 mx-auto bg-slate-700 rounded shadow text-left">
              <form onSubmit={handleForgotPassword} className="mb-3">
                ...
                <div className="forgetPass flex justify-center pt-4">
                  <button
                    className="btn btn-primary submit-btn p-3 rounded-3xl text-white w-full"
                    type="submit"
                  >
                    Get 4-digit code
                  </button>
