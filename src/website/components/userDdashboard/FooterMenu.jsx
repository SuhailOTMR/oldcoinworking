...
import doller from '../../assest/images/update_doller.png'
...
const FooterMenu = ()=> {
    ...
    return (
      <>
        <div className="footer-menu bg-gray-900">
          <div className="menu-items">
            <ul>
              ...
              <li
                onClick={() => handleMenuClick("cashout")}
                className={activeMenu === "cashout" ? "active" : ""}
              >
                <Link to="/cashout">
                  <button>
                    {" "}
              ...
              <li
                ...
                className={activeMenu === "earn" ? "active" : ""}
              >
                <button onClick={() => navigate("/dashboard")}>
                    {" "}
                    <img src={doller} alt="dollerImg" />
                    
                </button>
                {/* <span className="dollar-bg"></span> */}
                <p>
                  <Link to="/dashboard">Earn</Link>
                </p>
              </li>
              <li
                onClick={() => handleMenuClick("rewards")}
                className={activeMenu === "rewards" ? "active" : ""}
              >
                <Link to="/rewards">
                  <button>
                    {" "}
        ...
        <div
          className={!isOpenSidebar ? "mobile-sidebar" : "mobile-sidebar open"}
        >
          <div className="menu-items">
            <div>
              ...
              <ul>
                <li
                  onClick={() => handleMenuClick("surveys")}
                  className={activeMenu === "surveys" ? "active" : ""}
                >
                  <Link to="/allsurveys">
                    <button>
                      {" "}
                ...
                <li
                  ...
                  className={activeMenu === "affiliates" ? "active" : ""}
                >
                  <Link to="/affiliates">
                    <button>
                      {" "}
